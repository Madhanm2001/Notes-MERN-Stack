...
import { faFolder,faFileAlt, faListSquares } from '@fortawesome/free-solid-svg-icons'
...
const SideBarList = () => {
  ...
  return (
    <div ref={activeRef}>
      <div className='mt-[20px]' onClick={onclickSideBar}><FontAwesomeIcon icon={faListSquares} style={{ height: '18px', width: "18px" }} className={`p-3 rounded ${isFileOpen ? 'text-black bg-[#cdca00]' : 'text-black bg-[#878787]'} cursor-pointer`} /></div>
      {isFileOpen &&
        <div className='w-[275px] bg-[black] p-2 shadow-[0px_0px_10px_0px_grey]  absolute z-[100] p-3 rounded-md mx-auto h-[70vh] overflow-y-scroll overflow-x-hidden hide-scrollbar mx-auto'>
            ...
            {fileList.length>0 ?
              fileList.map((data) => {
                ...
                return (
                  ...
                  >
                    <FontAwesomeIcon
                      icon={window.location.pathname.includes('notes-content')?faFileAlt:faFolder}
                ...
                <h1 className='text-white font-bold text-[25px] mx-auto my-[50%]'>No Result Found</h1>
              )}
